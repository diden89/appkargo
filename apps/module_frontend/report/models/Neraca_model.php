 ...
 * @version 1.0
 * @access Public
 * @link /rab_frontend/apps/module_frontend/report/models/Neraca_model.php
 */

class Neraca_model extends NOOBS_Model
{

	public function get_akun_header($where = array(),$order = "")
	{
		foreach($where as $wh)
		{
