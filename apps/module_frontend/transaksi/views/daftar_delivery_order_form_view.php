...
<form role="form" id="addDaftarDeliveryOrder" autocomplete="off">
	<input type="hidden" name="action" value="store_data_daftar_delivery_order">
	<input type="hidden" name="mode" value="<?=$mode?>">
	<input type="hidden" name="last_notrx" value="<?php echo $mode == 'add' ?  $last_notrx.'/DO/'.date('Ymd') : $data->so_no_trx; ?>">
