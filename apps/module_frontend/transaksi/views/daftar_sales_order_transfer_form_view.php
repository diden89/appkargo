 ...
 * @version 1.0
 * @access Public
 * @path /rab_frontend/apps/module_frontend/transaksi/views/daftar_sales_order_transfer_form_view.php
 */
?>

<form role="form" id="addDaftarSalesOrderTransfer" autocomplete="off">
	<input type="hidden" name="action" value="store_data_daftar_sales_order_transfer">
	<input type="hidden" name="mode" value="<?=$mode?>">
	<input type="hidden" name="last_notrx" value="<?php echo $mode == 'add' ?  $last_notrx.'/SO/'.date('Ymd') : $data->sot_no_trx; ?>">
	<input type="hidden" name="sotd_id" value="" id="sotd_id">
	...
	<div class="row">		
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="sot_no_trx" class="form-control" id="no_trx_id" value="<?php echo $mode == 'edit' && $data !== FALSE ? $data->sot_no_trx : $last_notrx.'/SO/'.date('Ymd'); ?>" required="required" <?php echo $mode == 'edit' ? '' : ''; ?> disabled>
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group row">
				...
				<select class="form-control select2"  name="v_vendor_id" id="v_vendor_id">
					...
					<?php
						...
						{
							if($mode == 'edit' &&$data->sot_vendor_id == $v->v_id)
								{
									$sel = 'selected';
								}
								else
			...
			<div class="form-group row">
				...
				<div class="input-group col-md-8">
					<div class="input-group">
						...
						<input type="text" name="sot_created_date" class="form-control" id="created_date" required="required" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask value="">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-4">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" name="sotd_qty" class="form-control" id="sotd_qty" value="" >
				</div>
			</div>
			<!-- <div class="form-group row">
